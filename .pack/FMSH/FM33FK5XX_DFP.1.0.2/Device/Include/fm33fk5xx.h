 ...
 *           from CMSIS SVD File 'FM33FKXX.SVD' Version 1.0,
 *
...
/* -------------------  FM33FKXX Processor Exceptions Numbers  -------------------*/
...
/* --------------------  Cortex-M0 Specific Interrupt Numbers  --------------------*/
  ...
  I2CM0_IRQn                    = 38,               /*!<  38  I2CM0 */
  I2CM1_IRQn                    = 39,               /*!<  39  I2CM1 */
...
#include "core_cm33.h"                            /*!< Cortex-M0 processor and core peripherals */
#include "system_fm33fk5xx.h"                         /*!< FM33FKXX System */
...
typedef struct
{
  ...
  __IO uint32_t WKFR;                   /*!<  WakeupSourceFlagsRegister1,                           Address offset: 0x08 */
  ...
  __IO uint32_t RSV2[8];                /*!<  RESERVED REGISTER,                                    Address offset: 0x18 */
  __IO uint32_t ULPB_TR;                /*!<  ,                                                     Address offset: 0x38 */
...
typedef struct
{
  ...
  __IO uint32_t FDIER;                  /*!<  XTLFOscillationFailDetectionInterruptEnableRegister,  Address offset: 0x08 */
  __IO uint32_t FDISR;                  /*!<  XTLFOscillationFailDetectionInterruptStatusRegister,  Address offset: 0x0C */
  ...
  __IO uint32_t PUEN;                   /*!<  VAOIOPull-upEnableRegister,                           Address offset: 0x404 */
  ...
  __I  uint32_t DIR;                    /*!<  VAOIODataInputRegister,                               Address offset: 0x414 */
  __IO uint32_t VILR;                   /*!<  VAOIOVoltageInputLowRegister,                         Address offset: 0x418 */
}VAO_Type;
...
typedef struct
{
  ...
  __IO uint32_t AHBMCR;                 /*!<  AHBMasterControlRegister,                             Address offset: 0x54 */
...
typedef struct
{
  ...
  __IO uint32_t TO;                     /*!<  ,                                                     Address offset: 0x58 */
}EPSC_Type;
