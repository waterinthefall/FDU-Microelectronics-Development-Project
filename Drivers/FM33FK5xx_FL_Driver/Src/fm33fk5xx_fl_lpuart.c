...
#define         IS_FL_LPUART_CLKSRC(__VALUE__)             (((__VALUE__) == FL_CMU_LPUART0_CLK_SOURCE_XTLF)||\
                                                            ((__VALUE__) == FL_CMU_LPUART0_CLK_SOURCE_RCHF_PSC)||\
                                                            ((__VALUE__) == FL_CMU_LPUART1_CLK_SOURCE_XTLF)||\
                                                            ((__VALUE__) == FL_CMU_LPUART1_CLK_SOURCE_RCHF_PSC))
...
FL_ErrorStatus FL_LPUART_DeInit(LPUART_Type *LPUARTx)
{
    ...
    if(LPUARTx == LPUART0)
    {
        ...
        /* 外设工作时钟关闭 */
        FL_CMU_DisableGroup1OperationClock(FL_CMU_OPCLK_LPUART0);
    }
    else if(LPUARTx == LPUART1)
    {
        ...
        /* 外设工作时钟关闭 */
        FL_CMU_DisableGroup1OperationClock(FL_CMU_OPCLK_LPUART1);
    }
    else
    {
        status = FL_FAIL;
...
FL_ErrorStatus FL_LPUART_Init(LPUART_Type *LPUARTx, FL_LPUART_InitTypeDef *initStruct)
{
    ...
    if(LPUARTx == LPUART0)
    {
        ...
        /*操作时钟使能*/
        FL_CMU_EnableGroup1OperationClock(FL_CMU_OPCLK_LPUART0);
        /*时钟源选择*/
        FL_CMU_SetLPUART0ClockSource(initStruct->clockSrc);
    }
    else //if(LPUARTx == LPUART1)
    {
        /*总线时钟使能*/
        ...
        /*操作时钟使能*/
        FL_CMU_EnableGroup1OperationClock(FL_CMU_OPCLK_LPUART1);
        /*时钟源选择*/
        FL_CMU_SetLPUART1ClockSource(initStruct->clockSrc);
    }
