...
#define         IS_FL_UART_CLKSRC(__VALUE__)            (((__VALUE__) == FL_CMU_UART0_CLK_SOURCE_APBCLK)||\
                                                         ...
                                                         ((__VALUE__) == FL_CMU_UARTx_CLK_SOURCE_NONE))
...
FL_ErrorStatus FL_UART_DeInit(UART_Type *UARTx)
{
    ...
    if(UARTx == UART0)
    {
        ...
        /* 外设工作时钟关闭 */
        FL_CMU_DisableGroup1OperationClock(FL_CMU_OPCLK_UART0);
    }
    else if(UARTx == UART1)
    {
        /*复位UART*/
        ...
        /* 外设工作时钟关闭 */
        FL_CMU_DisableGroup1OperationClock(FL_CMU_OPCLK_UART1);
    }
    else if(UARTx == UART2)
    {
        /*复位UART*/
        ...
        /* 外设工作时钟关闭 */
        FL_CMU_DisableGroup1OperationClock(FL_CMU_OPCLK_UART2);
    }
    else if(UARTx == UART3)
    {
        /*复位UART*/
        ...
        /* 外设工作时钟关闭 */
        FL_CMU_DisableGroup1OperationClock(FL_CMU_OPCLK_UART3);
    }
    else if(UARTx == UART4)
    {
        /*复位UART*/
...
FL_ErrorStatus FL_UART_Init(UART_Type *UARTx, FL_UART_InitTypeDef *initStruct)
{
    ...
    if(UARTx == UART0)
    {
        ...
        FL_CMU_EnableGroup1OperationClock(FL_CMU_OPCLK_UART0);
    }
    else if(UARTx == UART1)
    {
        FL_CMU_EnableGroup3BusClock(FL_CMU_GROUP3_BUSCLK_UART1);
        FL_CMU_EnableGroup1OperationClock(FL_CMU_OPCLK_UART1);
    }
    else if(UARTx == UART2)
    {
        FL_CMU_EnableGroup3BusClock(FL_CMU_GROUP3_BUSCLK_UART2);
        FL_CMU_EnableGroup1OperationClock(FL_CMU_OPCLK_UART2);
    }
    else if(UARTx == UART3)
    {
        FL_CMU_EnableGroup3BusClock(FL_CMU_GROUP3_BUSCLK_UART3);
        FL_CMU_EnableGroup1OperationClock(FL_CMU_OPCLK_UART3);
    }
    else if(UARTx == UART4)
    {
...
FL_ErrorStatus FL_UART_InfraRed_Init(UART_Type *UARTx, FL_UART_InfraRed_InitTypeDef *initStruct)
{
    ...
    /*红外发送总线时钟使能*/
    FL_CMU_EnableGroup3BusClock(FL_CMU_GROUP3_BUSCLK_UCIR);
    /*红外发送使能*/
