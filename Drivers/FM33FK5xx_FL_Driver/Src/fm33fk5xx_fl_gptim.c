...
#define IS_FL_GPTIM_SLAVE_MODE(__VALUE__)             (((__VALUE__) == FL_GPTIM_SLAVE_MODE_PROHIBITED)\
                                                    ...
                                                    || ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_CLK)\
                                                                                                        ...
                                                                                                        || ((__VALUE__) == FL_GPTIM_SLAVE_MODE_QUADRATURE_ENCODER_X1_TI1FP1)\
                                                                                                        || ((__VALUE__) == FL_GPTIM_SLAVE_MODE_QUADRATURE_ENCODER_X1_TI2FP2))
...
#define IS_FL_GPTIM_OC_MODE(__VALUE__)               (((__VALUE__) ==   FL_GPTIM_OC_MODE_FROZEN) \
                                                      ...
                                                      || ((__VALUE__) == FL_GPTIM_OC_MODE_PWM2)\
                                                                                                            ...
                                                                                                            || ((__VALUE__) == FL_GPTIM_OC_MODE_COMBIME_PWM1)\
                                                                                                            || ((__VALUE__) == FL_GPTIM_OC_MODE_COMBIME_PWM2)\
                                                                                                            || ((__VALUE__) == FL_GPTIM_OC_MODE_DISSYMMETRIC_PWM1)\
                                                                                                            || ((__VALUE__) == FL_GPTIM_OC_MODE_DISSYMMETRIC_PWM2))
...
#define IS_FL_GPTIM_ETR_INPUT(__VALUE__)            (((__VALUE__) ==   FL_GPTIM_TIM_ETR_IN0) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN1) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN2) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN3) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN4) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN5) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN6) \
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN7)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN8)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN9)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN10)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN11)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN12)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN13)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN14)\
                                                     || ((__VALUE__) == FL_GPTIM_TIM_ETR_IN15))

#define IS_FL_GPTIM_TI_SELEST(__VALUE__)            (((__VALUE__) ==   FL_GPTIM_TIM_CH)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN1)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN2)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN3)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN4)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN5)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN6)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN7)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN8)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN9)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN10)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN11)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN12)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN13)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN14)\
                                                      || ((__VALUE__) == FL_GPTIM_TIM_TI_IN15))
...
/** @defgroup GPTIM_FL_Private_Functions GPTIM Private Functions
  * @{
  */
static FL_ErrorStatus  GPTIM_OCConfig(GPTIM_Type *TIMx, uint32_t Channel, FL_GPTIM_OC_InitTypeDef *TIM_OC_InitStruct);
...
FL_ErrorStatus FL_GPTIM_Init(GPTIM_Type *TIMx, FL_GPTIM_InitTypeDef *init)
{
    ...
    if(TIMx == GPTIM0)
    {
        FL_CMU_EnableGroup4BusClock(FL_CMU_GROUP4_BUSCLK_GTIM0);
    }
    else if(TIMx == GPTIM1)
    {
        FL_CMU_EnableGroup4BusClock(FL_CMU_GROUP4_BUSCLK_GTIM1);
    }
    else if(TIMx == GPTIM2)
    {
        FL_CMU_EnableGroup4BusClock(FL_CMU_GROUP4_BUSCLK_GTIM2);
    }
    /* 计数器计数模式配置 */
...
FL_ErrorStatus  FL_GPTIM_ETR_Init(GPTIM_Type *TIMx, FL_GPTIM_ETR_InitTypeDef *etr_init)
{
    ...
    assert_param(IS_FL_GPTIM_ETR_INPUT(etr_init->ETRInput));
    /* 时钟总线使能配置 */
    if(TIMx == GPTIM0)
    {
        FL_CMU_EnableGroup4BusClock(FL_CMU_GROUP4_BUSCLK_GTIM0);
    ...
    /* ETR的输入信号选择 */
    FL_GPTIM_SetETRSource(TIMx, etr_init->ETRInput);
    /* 外部时钟极性 */
...
FL_ErrorStatus FL_GPTIM_OC_Init(GPTIM_Type *TIMx, uint32_t channel, FL_GPTIM_OC_InitTypeDef *oc_init)
{
    ...
    /* 输出比较模式寄存器配置 */
    GPTIM_OCConfig(TIMx, channel, oc_init);
    /* 通道使能 */
...
/**
  ...
  *         -FL_FAIL 配置过程发生错误
  */
static FL_ErrorStatus GPTIM_OCConfig(GPTIM_Type *TIMx, uint32_t channel, FL_GPTIM_OC_InitTypeDef *oc_init)
{
    FL_ErrorStatus result = FL_PASS;
    /* 配置比较输出通道模式 */
...
FL_ErrorStatus FL_GPTIM_IC_Init(GPTIM_Type *TIMx, uint32_t channel, FL_GPTIM_IC_InitTypeDef *ic_init)
{
    ...
    assert_param(IS_FL_GPTIM_TI_SELEST(ic_init->ITSelect));
    /* 时钟总线使能配置 */
    if(TIMx == GPTIM0)
    {
        FL_CMU_EnableGroup4BusClock(FL_CMU_GROUP4_BUSCLK_GTIM0);
    ...
    /* 通道输入选择 */
    FL_GPTIM_SetTISource(TIMx, ic_init->ITSelect, channel);
    /*捕获极性 */
