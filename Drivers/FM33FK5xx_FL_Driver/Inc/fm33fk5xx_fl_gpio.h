...
#ifndef __FM33FK5XX_FL_GPIO_H
#define __FM33FK5XX_FL_GPIO_H
...
#define    GPIO_EXTISEL1_EXTI19_Pos                               (6U)
#define    GPIO_EXTISEL1_EXTI19_Msk                               (0x3U << GPIO_EXTISEL1_EXTI19_Pos)
#define    GPIO_EXTISEL1_EXTI19                                   GPIO_EXTISEL1_EXTI19_Msk

#define    GPIO_EXTISEL1_EXTI20_Pos                               (8U)
#define    GPIO_EXTISEL1_EXTI20_Msk                               (0x3U << GPIO_EXTISEL1_EXTI20_Pos)
#define    GPIO_EXTISEL1_EXTI20                                   GPIO_EXTISEL1_EXTI20_Msk

#define    GPIO_EXTISEL1_EXTI21_Pos                               (10U)
#define    GPIO_EXTISEL1_EXTI21_Msk                               (0x3U << GPIO_EXTISEL1_EXTI21_Pos)
#define    GPIO_EXTISEL1_EXTI21                                   GPIO_EXTISEL1_EXTI21_Msk
...
#define    GPIO_PINWKEN_SEL_Pos                                   (1U)
...
#define    FL_GPIO_EXTI_LINE_19                                   (0x1U << 19U)
#define    FL_GPIO_EXTI_LINE_20                                   (0x1U << 20U)
#define    FL_GPIO_EXTI_LINE_21                                   (0x1U << 21U)
...
#define    FL_GPIO_EXTI_LINE_19_PE12                              (0x0U << 6U)
#define    FL_GPIO_EXTI_LINE_19_PE13                              (0x1U << 6U)
#define    FL_GPIO_EXTI_LINE_19_PE14                              (0x2U << 6U)
#define    FL_GPIO_EXTI_LINE_19_PE15                              (0x3U << 6U)
#define    FL_GPIO_EXTI_LINE_20_PF0                               (0x0U << 8U)
#define    FL_GPIO_EXTI_LINE_20_PF1                               (0x1U << 8U)
#define    FL_GPIO_EXTI_LINE_20_PF2                               (0x2U << 8U)
#define    FL_GPIO_EXTI_LINE_20_PF3                               (0x3U << 8U)
#define    FL_GPIO_EXTI_LINE_21_PF4                               (0x0U << 10U)
#define    FL_GPIO_EXTI_LINE_21_PF5                               (0x1U << 10U)
...
#define    FL_GPIO_FOUT0_SELECT_TSC_VCOMP                         (0xaU << GPIO_FOUTSEL_FOUT0_Pos)
...
#define    FL_GPIO_FOUT0_SELECT_TSC_IDAC1_CHG_SW                  (0xdU << GPIO_FOUTSEL_FOUT0_Pos)
...
#define    FL_GPIO_FOUT1_SELECT_TSC_SW_SWCLK0                     (0x2U << GPIO_FOUTSEL_FOUT1_Pos)
#define    FL_GPIO_FOUT1_SELECT_BGSH_SWEN1O                       (0x3U << GPIO_FOUTSEL_FOUT1_Pos)
#define    FL_GPIO_FOUT1_SELECT_EOC                               (0x4U << GPIO_FOUTSEL_FOUT1_Pos)
#define    FL_GPIO_FOUT1_SELECT_BGSH_SWEN20                       (0x5U << GPIO_FOUTSEL_FOUT1_Pos)
...
#define    FL_GPIO_FOUT1_SELECT_TSC_SHIELD_SWCLK                  (0xaU << GPIO_FOUTSEL_FOUT1_Pos)
...
/**
  ...
  *           @arg @ref FL_GPIO_EXTI_LINE_19
  *           @arg @ref FL_GPIO_EXTI_LINE_20
  *           @arg @ref FL_GPIO_EXTI_LINE_21
  * @param    edge This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_EXTI_TRIGGER_EDGE_RISING
  *           @arg @ref FL_GPIO_EXTI_TRIGGER_EDGE_FALLING
  *           @arg @ref FL_GPIO_EXTI_TRIGGER_EDGE_BOTH
...
{
    MODIFY_REG(GPIOx->EXTIEDS1, ((line * line) * GPIO_EXTIEDS1), ((line * line) * edge));
}
...
{
    return (uint32_t)(READ_BIT(GPIOx->EXTIEDS1, ((line * line) * GPIO_EXTIEDS1)) / (line * line));
}
...
{
    SET_BIT(GPIOx->EXTIDF, ((line & 0x3fffffU) << 0x0U));
}
...
{
    CLEAR_BIT(GPIOx->EXTIDF, ((line & 0x3fffffU) << 0x0U));
}
...
{
    return (uint32_t)(READ_BIT(GPIOx->EXTIDF, ((line & 0x3fffffU) << 0x0U)) == ((line & 0x3fffffU) << 0x0U));
}
...
{
    return (uint32_t)(READ_BIT(GPIOx->EXTIISR, ((line & 0x3fffffU) << 0x0U)) == ((line & 0x3fffffU) << 0x0U));
}
...
{
    WRITE_REG(GPIOx->EXTIISR, ((line & 0x3fffffU) << 0x0U));
}
...
{
    return (uint32_t)(READ_BIT(GPIOx->EXTIDI, ((line & 0x3fffffU) << 0x0U)) == ((line & 0x3fffffU) << 0x0U));
}
...
{
    return (uint32_t)(READ_BIT(GPIOx->EXTIDI, 0x3fffffU) >> 0U);
}
...
/**
  ...
  *           @arg @ref FL_GPIO_FOUT0_SELECT_TSC_VCOMP
  *           @arg @ref FL_GPIO_FOUT0_SELECT_RCHF
  *           @arg @ref FL_GPIO_FOUT0_SELECT_XTHF_DIV64
  *           @arg @ref FL_GPIO_FOUT0_SELECT_TSC_IDAC1_CHG_SW
...
/**
  ...
  *           @arg @ref FL_GPIO_FOUT1_SELECT_TSC_SW_SWCLK0
  *           @arg @ref FL_GPIO_FOUT1_SELECT_BGSH_SWEN1O
  *           @arg @ref FL_GPIO_FOUT1_SELECT_EOC
  *           @arg @ref FL_GPIO_FOUT1_SELECT_BGSH_SWEN20
  ...
  *           @arg @ref FL_GPIO_FOUT1_SELECT_TSC_SHIELD_SWCLK
...
/**
  ...
  *           @arg @ref FL_GPIO_EXTI_LINE_18_PE10
  *           @arg @ref FL_GPIO_EXTI_LINE_18_PE11
  * @retval   None
  */
...
/**
  * @brief    Set EXTI19 interrupt input
  * @rmtoll   EXTISEL1    EXTI19    FL_GPIO_SetExtiLine19
  * @param    GPIOx GPIO Port
  * @param    EXTIPin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_EXTI_LINE_19_PE12
  *           @arg @ref FL_GPIO_EXTI_LINE_19_PE13
  *           @arg @ref FL_GPIO_EXTI_LINE_19_PE14
  *           @arg @ref FL_GPIO_EXTI_LINE_19_PE15
  * @retval   None
  */
__STATIC_INLINE void FL_GPIO_SetExtiLine19(GPIO_COMMON_Type *GPIOx, uint32_t EXTIPin)
{
    MODIFY_REG(GPIOx->EXTISEL1, GPIO_EXTISEL1_EXTI19_Msk, EXTIPin);
}

/**
  * @brief    Get EXTI19 interrupt input
  * @rmtoll   EXTISEL1    EXTI19    FL_GPIO_GetExtiLine19
  * @param    GPIOx GPIO Port
  * @retval   Returned value can be one of the following values:
  */
__STATIC_INLINE uint32_t FL_GPIO_GetExtiLine19(GPIO_COMMON_Type *GPIOx)
{
    return (uint32_t)(READ_BIT(GPIOx->EXTISEL1, GPIO_EXTISEL1_EXTI19_Msk));
}

/**
  * @brief    Set EXTI20 interrupt input
  * @rmtoll   EXTISEL1    EXTI20    FL_GPIO_SetExtiLine20
  * @param    GPIOx GPIO Port
  * @param    EXTIPin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_EXTI_LINE_20_PF0
  *           @arg @ref FL_GPIO_EXTI_LINE_20_PF1
  *           @arg @ref FL_GPIO_EXTI_LINE_20_PF2
  *           @arg @ref FL_GPIO_EXTI_LINE_20_PF3
  * @retval   None
  */
__STATIC_INLINE void FL_GPIO_SetExtiLine20(GPIO_COMMON_Type *GPIOx, uint32_t EXTIPin)
{
    MODIFY_REG(GPIOx->EXTISEL1, GPIO_EXTISEL1_EXTI20_Msk, EXTIPin);
}

/**
  * @brief    Get EXTI20 interrupt input
  * @rmtoll   EXTISEL1    EXTI20    FL_GPIO_GetExtiLine20
  * @param    GPIOx GPIO Port
  * @retval   Returned value can be one of the following values:
  */
__STATIC_INLINE uint32_t FL_GPIO_GetExtiLine20(GPIO_COMMON_Type *GPIOx)
{
    return (uint32_t)(READ_BIT(GPIOx->EXTISEL1, GPIO_EXTISEL1_EXTI20_Msk));
}

/**
  * @brief    Set EXTI21 interrupt input
  * @rmtoll   EXTISEL1    EXTI21    FL_GPIO_SetExtiLine21
  * @param    GPIOx GPIO Port
  * @param    EXTIPin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_EXTI_LINE_21_PF4
  *           @arg @ref FL_GPIO_EXTI_LINE_21_PF5
  * @retval   None
  */
__STATIC_INLINE void FL_GPIO_SetExtiLine21(GPIO_COMMON_Type *GPIOx, uint32_t EXTIPin)
{
    MODIFY_REG(GPIOx->EXTISEL1, GPIO_EXTISEL1_EXTI21_Msk, EXTIPin);
}

/**
  * @brief    Get EXTI21 interrupt input
  * @rmtoll   EXTISEL1    EXTI21    FL_GPIO_GetExtiLine21
  * @param    GPIOx GPIO Port
  * @retval   Returned value can be one of the following values:
  */
...
/** @defgroup GPIO_FL_EF_Operation Opeartion functions
  * @{
  */
