...
#ifndef __FM33FK5XX_FL_DAC_H
#define __FM33FK5XX_FL_DAC_H
...
#define    DAC_IER_DMAERR_Pos                                     (3U)
#define    DAC_IER_DMAERR_Msk                                     (0x1U << DAC_IER_DMAERR_Pos)
#define    DAC_IER_DMAERR                                         DAC_IER_DMAERR_Msk

#define    DAC_IER_EOH_Pos                                        (2U)
#define    DAC_IER_EOH_Msk                                        (0x1U << DAC_IER_EOH_Pos)
#define    DAC_IER_EOH                                            DAC_IER_EOH_Msk

#define    DAC_IER_EOS_Pos                                        (1U)
#define    DAC_IER_EOS_Msk                                        (0x1U << DAC_IER_EOS_Pos)
#define    DAC_IER_EOS                                            DAC_IER_EOS_Msk

#define    DAC_IER_DOU_Pos                                        (0U)
#define    DAC_IER_DOU_Msk                                        (0x1U << DAC_IER_DOU_Pos)
#define    DAC_IER_DOU                                            DAC_IER_DOU_Msk
...
#define    FL_DAC_TRGI_ATIM0                                      (0x1U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_ATIM1                                      (0x2U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_GPTIM0                                     (0x3U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_GPTIM1                                     (0x4U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_GPTIM2                                     (0x5U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_BSTIM16                                    (0x6U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_LPTIM16                                    (0x7U << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_EXTIA                                      (0xaU << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_EXTIB                                      (0xbU << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_EXTIC                                      (0xcU << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_EXTID                                      (0xdU << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_EXTIE                                      (0xeU << DAC_CFGR_TRGSEL_Pos)
#define    FL_DAC_TRGI_EXTIF                                      (0xfU << DAC_CFGR_TRGSEL_Pos)

#define    FL_DAC_SAMPLE_CONTINUE                                  (0x0U << DAC_CFGR_SHEN_Pos)
#define    FL_DAC_SAMPLE_SAMPLEHOLD                                (0x1U << DAC_CFGR_SHEN_Pos)
/**
  * @}
  */
/* Exported functions ---------------------------------------------------------------------------------*/
...
/**
  ...
  *           @arg @ref FL_DAC_TRGI_ATIM0
  *           @arg @ref FL_DAC_TRGI_ATIM1
  *           @arg @ref FL_DAC_TRGI_GPTIM0
  *           @arg @ref FL_DAC_TRGI_GPTIM1
  *           @arg @ref FL_DAC_TRGI_GPTIM2
  *           @arg @ref FL_DAC_TRGI_BSTIM16
  *           @arg @ref FL_DAC_TRGI_LPTIM16
  *           @arg @ref FL_DAC_TRGI_EXTIA
  *           @arg @ref FL_DAC_TRGI_EXTIB
  *           @arg @ref FL_DAC_TRGI_EXTIC
  *           @arg @ref FL_DAC_TRGI_EXTID
  *           @arg @ref FL_DAC_TRGI_EXTIE
  *           @arg @ref FL_DAC_TRGI_EXTIF
  * @retval   None
  */
...
/**
  * @brief    Enable DAC Output Switch
  * @rmtoll   CFGR    SWIEN    FL_DAC_EnableOutputSwitch
  * @param    DACx DAC instance
  * @retval   None
  */
__STATIC_INLINE void FL_DAC_EnableOutputSwitch(DAC_Type *DACx)
{
...
/**
  ...
  * @rmtoll   CFGR    SWIEN    FL_DAC_DisableOutputSwitch
  * @param    DACx DAC instance
  * @retval   None
  */
__STATIC_INLINE void FL_DAC_DisableOutputSwitch(DAC_Type *DACx)
{
    CLEAR_BIT(DACx->CFGR, DAC_CFGR_SWIEN_Msk);
}

/**
  * @brief    Get DAC Output  Switch
  * @rmtoll   CFGR    SWIEN    FL_DAC_IsEnabledOutputSwitch
  * @param    DACx DAC instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_DAC_IsEnabledOutputSwitch(DAC_Type *DACx)
{
