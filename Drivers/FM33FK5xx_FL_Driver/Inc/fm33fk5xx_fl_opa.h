...
#ifndef __FM33FK5XX_FL_OPA_H
#define __FM33FK5XX_FL_OPA_H
...
#define    OPA_CR_PGA_INVSEL_Pos                                  (7U)
#define    OPA_CR_PGA_INVSEL_Msk                                  (0x1U << OPA_CR_PGA_INVSEL_Pos)
#define    OPA_CR_PGA_INVSEL                                      OPA_CR_PGA_INVSEL_Msk
...
#define    FL_OPA_PGA_MODE_RFU                                    (0x0U << OPA_CR_MSEL_Pos)
...
/**
  * @brief
  * @rmtoll   CR    PGA_INVSEL    FL_OPA_EnablePGAInvert
  * @param    OPAx OPA instance
  * @retval   None
  */
__STATIC_INLINE void FL_OPA_EnablePGAInvert(OPA_Type *OPAx)
{
    SET_BIT(OPAx->CR, OPA_CR_PGA_INVSEL_Msk);
}

/**
  * @brief    Get OPA Enable Status
  * @rmtoll   CR    PGA_INVSEL    FL_OPA_IsEnabledPGAInvert
  * @param    OPAx OPA instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_OPA_IsEnabledPGAInvert(OPA_Type *OPAx)
{
    return (uint32_t)(READ_BIT(OPAx->CR, OPA_CR_PGA_INVSEL_Msk) == OPA_CR_PGA_INVSEL_Msk);
}

/**
  * @brief    Disable OPA
  * @rmtoll   CR    PGA_INVSEL    FL_OPA_DisablePGAInvert
  * @param    OPAx OPA instance
  * @retval   None
  */
__STATIC_INLINE void FL_OPA_DisablePGAInvert(OPA_Type *OPAx)
{
    CLEAR_BIT(OPAx->CR, OPA_CR_PGA_INVSEL_Msk);
}
